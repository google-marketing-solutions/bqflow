...
DCM_Field_Lookup = {
  ...
  'Clicks':'INTEGER',
  'Warnings':'INTEGER',
  'Paid_Search_Advertiser_Id':'STRING',
  ...
  'Paid_Search_External_Campaign_Id':'STRING',
  ...
  'Package_Roadblock_Id':'STRING',
  'Recalculated_Attribution_Type':'STRING',
  'Dbm_Advertiser_Id':'STRING',
  ...
  'User_List':'STRING',
  'Event_Timers':'FLOAT',
  'Paid_Search_External_Keyword_Id':'STRING',
  'Timers':'INTEGER',
  ...
  'Paid_Search_Engine_Account_Id':'STRING',
  ...
  'Paid_Search_External_Ad_Id':'STRING',
  ...
  'Paid_Search_Bid_Strategy_Id':'STRING',
  'Interactive_Impressions':'INTEGER',
  'Interaction_Count_Natural_Search':'INTEGER',
  'Twitter_Impression_Id':'STRING',
  'Ad':'STRING',
  'Paid_Search_Ad_Group_Id':'STRING',
  'Paid_Search_Campaign_Id':'STRING',
